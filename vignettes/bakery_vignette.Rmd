...
Note that the `glmWaldTest` function is flexible towards "multi-contrast" settings. I demonstrate this using new simulated data, mimicking a multi-patient multi-celltype setting.
